...
if mode == "Search & Save CPEs":
    ...
    if st.button("Search") and keyword_input:
        ...
        st.session_state.cpe_session_list.clear()
        st.session_state.cpe_title_map.clear()
    ...
    if st.session_state.search_results:
        ...
        selected_cpes = edited_df['cpeName'].tolist()
        st.session_state.cpe_session_list = selected_cpes
        st.session_state.cpe_title_map = dict(zip(df_results['cpeName'], df_results['title']))
